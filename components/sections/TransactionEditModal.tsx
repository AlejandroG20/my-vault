...
export default function TransactionEditModal({ transaction }: { transaction: Transaction }) {
            ...
            <form ref={formRef} action={handleSubmit} className="p-5 flex flex-col gap-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <select name="type" required defaultValue={transaction.type} className={selectClass}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1.5">
                  ...
                  <select name="category" required defaultValue={transaction.category} className={selectClass}>
                    {CATEGORIES.map((cat) => (
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-primary-500 uppercase tracking-wide">
                  Descripción{" "}
                  <span className="normal-case font-normal text-primary-300">(opcional)</span>
                </label>
                <input
                  name="description"
                  type="text"
